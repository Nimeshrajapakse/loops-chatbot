...
export async function handleChat(body) {
    try {
        console.log("[CHAT] Request received with language mode:", body.languageMode);
...
Rules:
1. If a question is unrelated to Loops Integrated or marketing, start your reply with [OFF_TOPIC] followed by "I handle Loops-related questions. If you want, I can connect you with a human representative. Please fill in your details below."
...
`;
        ...
        console.log("[CHAT] Language hint added:", languageHint || "(none - auto-detect from message)");
